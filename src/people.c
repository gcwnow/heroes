...
** 
** DO NOT EDIT THIS FILE   (people.c)
** 
** It has been AutoGen-ed  October  9, 2012 at 07:17:54 PM by AutoGen 5.15
** From the definitions    people.def
...
const a_strpair people_strings[] = {
  ...
  { "%{>>>}Artur Rojek (%bOpenDingux A320/GCW0%w)\n", false },
  { "%{>>>}Maxim Sobolev (%bFreeBSD%w)\n", false },
